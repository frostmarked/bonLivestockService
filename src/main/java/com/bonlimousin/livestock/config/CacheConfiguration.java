package com.bonlimousin.livestock.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bonLivestockService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bonLivestockService");
        ...
        config.getMapConfigs().put("com.bonlimousin.livestock.domain.*", initializeDomainMapConfig(jHipsterProperties));
