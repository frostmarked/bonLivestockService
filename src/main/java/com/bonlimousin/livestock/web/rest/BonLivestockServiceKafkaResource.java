...
@RestController
@RequestMapping("/api/bon-livestock-service-kafka")
public class BonLivestockServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BonLivestockServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BonLivestockServiceKafkaResource(KafkaProperties kafkaProperties) {
